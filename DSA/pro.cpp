...
void read_record() {
    ...
    strcpy(ADM.ob[0].company,"Shree Ram Travels"); strcpy(ADM.ob[0].bus_id,"UP16BC5555"); ADM.ob[0].bus_status=1;
    strcpy(ADM.ob[1].company,"Leo Travels"); strcpy(ADM.ob[1].bus_id,"DL05OK1234"); ADM.ob[1].bus_status=1;
    strcpy(ADM.ob[2].company,"Shatabdi Travels"); strcpy(ADM.ob[2].bus_id,"UP14AO1352"); ADM.ob[2].bus_status=1;
    strcpy(ADM.ob[3].company,"Define Travels"); strcpy(ADM.ob[3].bus_id,"DL11CW1738"); ADM.ob[3].bus_status=1;
    strcpy(ADM.ob[4].company,"Yadav Ji Travels"); strcpy(ADM.ob[4].bus_id,"UP16GUJJAR"); ADM.ob[4].bus_status=1;
}
